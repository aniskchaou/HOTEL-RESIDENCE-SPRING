...
public class BookingController {
	...
	public String getSummaryBooking(@PathVariable("id") Long id, Model model) throws ParseException {
		...
		double subtotal = invoiceService.calculateSubTotalPrice(invoiceRepository,checkIn);
		double total = invoiceService.calculatetotalPrice(invoiceRepository,checkIn);
		double vatrate = invoiceService.calculatevatrate(invoiceRepository,checkIn);
